 ...
 *******************************************************************************/
#include "com_jaspersoft_studio_editor_java2d_Win32ImageRenderer.h"
#include <windows.h>

/*
 * Class:     com_jaspersoft_studio.designer_java2d_Win32ImageRenderer
 * Method:    renderImage
 * Signature: (IIIIIII[III)V
 */
JNIEXPORT void JNICALL Java_com_jaspersoft_studio_editor_java2d_Win32ImageRenderer_renderImage
